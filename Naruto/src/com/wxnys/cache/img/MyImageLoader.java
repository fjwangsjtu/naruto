 ...
 * {@link MyImageLoader#get(String, ImageListener)} and to pass in the default
 * image listener provided by
 * {@link MyImageLoader#getImageListener(ImageView, int, int)}. Note that all
...
public class MyImageLoader {
	 ...
	 * responses.
	 */
	private int mBatchResponseDelayMs = 5;
	 ...
	 * {@link MyImageLoader} will be invoked when the request is fulfilled.
	 * 
	 * @param requestUrl
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener,
		...
		// network and
		// track it.
		Request<?> newRequest = new MyImageRequest(requestUrl,
				new Listener<Bitmap>() {
					@Override
